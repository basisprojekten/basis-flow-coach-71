        ...
        try {
          ...
          if (code.type === 'exercise') {
            ...
            const { data: exercise, error: exerciseError } = await supabase
              .from('exercises')
              .select('title, instruction_document_id')
              .eq('id', targetId)
              .maybeSingle();
            ...
            if (exerciseError) {
              ...
              details = { instruction_document_id: (exercise as any).instruction_document_id };
            }
          ...
          return {
            ...
            created_at: code.created_at,
            title: 'Unknown',
            details: code.type === 'exercise' ? { instruction_document_id: null } : {}
          };
        }
      })
    );
